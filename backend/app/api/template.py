...
from app.models.ppt.user_template import UserTemplate  # 用户模板模型
from app.utils.response import success_response, error_response  # 统一响应工具
from app.utils.validators import allowed_file  # 文件验证工具
...
async def upload_template(
    ...
    try:
        ...
        # 校验文件类型
        if not allowed_file(template_image.filename, Config.ALLOWED_EXTENSIONS):
            raise HTTPException(
                status_code=400,
